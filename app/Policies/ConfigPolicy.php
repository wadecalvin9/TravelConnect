...
class ConfigPolicy
{
    ...
    {
        return $user->can('force_delete_config');
    }
    ...
    {
        return $user->can('force_delete_any_config');
    }
    ...
    {
        return $user->can('restore_config');
    }
    ...
    {
        return $user->can('restore_any_config');
    }
    ...
    {
        return $user->can('replicate_config');
    }
    ...
    {
        return $user->can('reorder_config');
    }
}
