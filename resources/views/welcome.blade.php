<x-main>
                     ...
                     <div class="carousel-item active">
                        <div class="card border-0 shadow-lg rounded-3 overflow-hidden glass-card">
                            <img src="{{ $destination->image }}"
                                class="card-img fixed-img" alt="Paris">
    ...
    <section class="py-5">
        <div class="container position-relative">
            ...
            <div class="d-flex overflow-auto pb-3 gap-3 scrollable-wrapper">
                <!-- Tour Cards -->
                @foreach ($tours as $tour )
                    @if ($tour->popular == true)
                    <div class="card glass-card" style="min-width: 250px; flex: 0 0 auto;">
    ...
    <section class="py-5 bg-light">
        <div class="container text-center">
            ...
            <div class="d-flex gap-4 overflow-auto pb-3 scrollable-wrapper">
                <!-- Package Cards -->
                @foreach ($tours as $tour)
                    @if ($tour->special == true)
                    <div class="card glass-card border-0 shadow" style="min-width: 300px; flex: 0 0 auto;">
                    <img src="{{ $tour->image }}" class="card-img-top"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="card glass-card border-0 shadow-sm mx-auto" style="max-width: 600px;">
                            <div class="card-body">
                                <p class="card-text fst-italic">"Our trip to Paris was magical. Everything was
                                    perfectly planned."</p>
                    ...
                    <div class="carousel-item">
                        <div class="card glass-card border-0 shadow-sm mx-auto" style="max-width: 600px;">
                            <div class="card-body">
                                <p class="card-text fst-italic">"The Tokyo package was a dream come true. From temples
                                    to modern city life."</p>
                                <div class="d-flex align-items-center justify-content-center mt-4">
    ...
    <!-- JS for Tour Carousel -->
    <script>
        const tourCarousel = document.querySelectorAll(".scrollable-wrapper");
        tourCarousel.forEach(wrapper => {
            wrapper.parentNode.querySelector("#prevBtn")?.addEventListener("click", () => {
                wrapper.scrollBy({
                    left: -260,
                    behavior: "smooth"
                });
            });
            wrapper.parentNode.querySelector("#nextBtn")?.addEventListener("click", () => {
                wrapper.scrollBy({
                    left: 260,
                    behavior: "smooth"
                });
